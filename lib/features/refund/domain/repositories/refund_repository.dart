...
import 'package:stuwrite_vendor/features/refund/domain/repositories/refund_repository_interface.dart';
...
class RefundRepository implements RefundRepositoryInterface{
  ...
  @override
  Future<ApiResponse> getRefundList(String? status, String? startDate, String? endDate) async {
    try {
      final response = await dioClient!.get('${AppConstants.refundListUri}?date_type=$status&start_date=$startDate&end_date=$endDate');
      return ApiResponse.withSuccess(response);
    } catch (e) {
      return ApiResponse.withError(ApiErrorHandler.getMessage(e));
    }
