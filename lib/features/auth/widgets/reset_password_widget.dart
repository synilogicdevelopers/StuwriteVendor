...
import 'package:stuwrite_vendor/features/auth/widgets/pass_view.dart';
...
import 'package:stuwrite_vendor/common/basewidgets/textfeild/custom_pass_textfeild_widget.dart';
...
class ResetPasswordWidget extends StatefulWidget {
  ...
  final String otp;
  final String? token;
  const ResetPasswordWidget({super.key,required this.mobileNumber,required this.otp, this.token});
  ...
  void resetPassword() async {
    ...
    if (password.isEmpty) {
      ...
      Provider.of<AuthController>(context, listen: false).resetPassword(widget.mobileNumber,widget.otp,
          password, confirmPassword, widget.token).then((value) {
        if(value.isSuccess) {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        body: Column(
          children: [
            SizedBox(height: Dimensions.paddingSizeButton),
