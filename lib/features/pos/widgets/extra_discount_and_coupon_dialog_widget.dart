...
import 'package:stuwrite_vendor/common/basewidgets/custom_snackbar_widget.dart' show SnackBarType, showCustomSnackBarWidget;
...
import 'package:stuwrite_vendor/common/basewidgets/custom_field_with_title_widget.dart';
                ...
                child: Row(children: [
                  ...
                  onTap: () async{
                    if((double.tryParse(couponDiscountController.extraDiscountController.text) ?? 0) <= 0) {
                      ...
                      Provider.of<CartController>(Get.context!, listen: false).setUpdatePaidAmount(true, isUpdate: true);
                      Navigator.pop(Get.context!);
                    }
