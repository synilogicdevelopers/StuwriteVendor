        ...
        decoration: InputDecoration(
          ...
          suffixIcon: Container(
            ...
            child: Row(
              ...
              children: [
                Text(_isDiscountAmount ? '${getTranslated('amount', context)} (${splashProvider.myCurrency!.symbol ?? '' })' : '${getTranslated('percent', context)} %',
                ...
                PopupMenuButton<int>(
                  ...
                  child: Icon(Icons.arrow_drop_down, color: Theme.of(context).hintColor, size: Dimensions.paddingSizeDefault),
                ),
